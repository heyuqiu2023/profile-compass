...
const experiences = [
  {
    ...
    endDate: "",
    isCurrent: true,
    description: "Working on frontend infrastructure for Google Cloud Console. Built reusable component library used by 20+ teams. Improved page load times by 30% through code splitting and lazy loading optimisations.",
  },
  {
    id: "2",
    type: "Society Role",
    ...
    endDate: "2025-06",
    isCurrent: false,
    description: "Led a team of 30 committee members. Organised 15+ events including hackathons, speaker sessions, and workshops with industry partners like Google, Meta, and Bloomberg.",
  },
  {
    id: "3",
    type: "Project",
    ...
    endDate: "2024-06",
    isCurrent: false,
    description: "Built a personal finance tracker with React and Supabase. Features include bank sync, budget tracking, and spending analytics. 500+ users in first month of launch.",
  },
  {
    id: "4",
    type: "Research",
    title: "Undergraduate Researcher",
    organisation: "UCL NLP Group",
    startDate: "2024-01",
    endDate: "2024-05",
    isCurrent: false,
    description: "Researched transformer-based models for financial sentiment analysis. Co-authored paper submitted to ACL 2025.",
  },
];
...
const skills = ["Python", "React", "TypeScript", "Figma", "SQL", "TensorFlow", "Docker", "Node.js"];
const interests = ["Fintech", "UI Design", "Sustainability", "Machine Learning", "Open Source"];
      ...
      <div className="flex gap-4 pb-8 group">
        ...
        >
          <div className="flex items-center gap-2 flex-wrap">
            <span className={`text-xs px-2.5 py-0.5 rounded-full font-medium border ${TYPE_COLORS[exp.type] || TYPE_COLORS.Other}`}>
              {exp.type}
            </span>
            {exp.isCurrent && (
      ...
      <section className="pt-16 pb-12 md:pt-24 md:pb-16">
        <div className="container max-w-3xl px-6">
          ...
          >
            ...
            >
              {profile.linkedinUrl && (
                <a href={profile.linkedinUrl} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors">
                  <Linkedin className="w-4 h-4" />
                </a>
              )}
              {profile.githubUrl && (
                <a href={profile.githubUrl} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors">
                  <Github className="w-4 h-4" />
                </a>
              )}
              {profile.websiteUrl && (
                <a href={profile.websiteUrl} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors">
            ...
            <div className="flex flex-wrap gap-2">
              {interests.map((interest, i) => (
                <motion.span
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.04, duration: 0.3 }}
                  className="px-3 py-1.5 rounded-full border border-border text-muted-foreground text-sm font-medium hover:border-primary/50 hover:text-foreground transition-colors"
                >
                  {interest}
                </motion.span>
              ))}
